...
CREATE TYPE "public"."staff_role" AS ENUM('owner', 'manager', 'fulfilment', 'content', 'support');--> statement-breakpoint
...
CREATE INDEX "staff_profile_role_idx" ON "staff_profile" USING btree ("role");--> statement-breakpoint
